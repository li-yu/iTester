package com.liyu.itester.touch;
...
public class BorderTouchView extends View {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        case MotionEvent.ACTION_DOWN:
        	mCon.sendBroadcast(new Intent("com.liyu.itester.hide"));
           touchDown(x, y);
           invalidate();
            break;
        ...
        case MotionEvent.ACTION_UP:
        	mCon.sendBroadcast(new Intent("com.liyu.itester.show"));
            touchUp();
            invalidate();
            break;
        }
